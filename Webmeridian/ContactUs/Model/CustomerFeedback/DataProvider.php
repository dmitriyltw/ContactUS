...
namespace Webmeridian\ContactUs\Model\CustomerFeedback;

use Webmeridian\ContactUs\Model\ResourceModel\CustomerFeedback\CollectionFactory;
...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        $data = $this->dataPersistor->get('webmeridian_contactus_customerfeedback');
